...
![Sales & Profit Overview](dashboard/Dashboard1.png)
![Category Performance](dashboard/Dashboard2.png)
![Customer Behavior Analysis](dashboard/Dashboard3.png)
...
├── outputs/       # Images / exports / final visuals
├── README.md
└── .gitignore
```
...
* Certain beauty categories drive **disproportionately high revenue**
* A small customer segment contributes to **repeat purchases**
* Profit margins vary significantly across product types
* Seasonal spikes influence order volume and sales
